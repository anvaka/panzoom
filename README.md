...
```
<script src='https://cdn.rawgit.com/anvaka/panzoom/v6.1.1/dist/panzoom.min.js'></script>
```
...
<html>
<head>
  <script src='https://cdn.rawgit.com/anvaka/panzoom/v6.1.1/dist/panzoom.min.js'
